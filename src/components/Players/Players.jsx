        ...
        <>
            <section class="my-5">
                <div class="h-auto mx-8 lg:mx-28 my-5 flex items-center justify-between">
                    ...
                    <div>
                        <button class="relative group border-2 border-green-300 px-3 py-1 rounded-md duration-500 transition-all">
                            View All
                            <span class="absolute w-0 bottom-0 left-0 h-0 group-hover:w-full group-hover:h-full bg-green-300 duration-500 transition-all"></span>
                        </button>
                    </div>
                </div>
